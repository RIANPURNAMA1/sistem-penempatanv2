...
const CACHE_PREFIX = 'perusahaan';

const invalidatePerusahaanCache = async () => {
...
const getAll = async (req, res) => {
  try {
    ...
    const cacheKey = `perusahaan:${JSON.stringify({ search, status })}`;
...
const create = async (req, res) => {
  try {
    ...
    await invalidatePerusahaanCache();
