...
export default function CvTemplate({
  ...
  const pendidikans: Pendidikan[] = cv.pendidikans ?? [];
  const pengalamans: Pengalaman[] = cv.pengalamans ?? [];
          ...
          >
                ...
                <table className="cv-table">
                  <tbody>
                    <tr>
                      ...
                      <td rowSpan={2}></td>
                      <td className="bg-header" style={{ width: "130px" }}>
                        身長 TINGGI BADAN
                      </td>
                    ...
                    <tr>
                      <td colSpan={2} className="bg-header text-center">
                        名前 NAMA
                      </td>
                    ...
                    <tr>
                      <td className="bg-header text-center">
                        性別 JENIS KELAMIN
                      </td>
                      ...
                      <td colSpan={4} className="text-center">
                        {cv.tangan_dominan || "-"} （
                        {cv.tangan_dominan === "Kanan" ? "右" : "左"}）
                      </td>
                    </tr>

                    <tr>
                      <td className="bg-header text-center" rowSpan={3}>
                        携帯電話番号 NO HP
                      </td>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <tbody>
                <tr>
                  <td
                    className="bg-header label-text"
                    style={{
                      border: "1px solid black",
                      borderTop: "none",
                      padding: "4px",
              ...
              <tbody>
                ...
                {cv.kakak_nama && cv.kakak_nama !== "なし" && (
                  <tr>
                    ...
                    >
                      {cv.kakak_usia
                        ? `${cv.kakak_usia.replace("歳", "").trim()} 歳`
                        : "-"}
                    </td>
                    <td
                      className="value-text"
                ...
                {cv.istri_nama && cv.istri_nama !== "なし" && (
                  <tr>
                    ...
                    >
                      {cv.istri_usia
                        ? `${cv.istri_usia.replace("歳", "").trim()} 歳`
                        : "-"}
                    </td>
                    <td
                      className="value-text"
            ...
            >
              <tbody>
                ...
                <tr>
                  ...
                  >
                    回国後の目標　TUJUAN SETELAH PULANG DARI JEPANG
                  </td>
                  <td
                    className="value-text"
                    style={{
                  ...
                  >
                    {cv.tujuanSetelahPulang?.tujuan_setelah_pulang || "-"}
                  </td>
                </tr>
                <tr>
                  <td
            ...
            >
              <tbody>
                ...
                <tr>
                  ...
                  >
                    JFT {cv.kemampuan_bahasa_jepang || "-"}
                  </td>
                  <td
                    className="bg-header label-text"
                    style={{
                  ...
                  >
                    ...
                    {mappingSertifikat[cv.bidang_sertifikasi || ""] || "-"}）
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            >
              <tbody>
                ...
                <tr>
                  ...
                  >
                    {cv.ada_keluarga_di_jepang === "Ya"
                      ? cv.hubungan_keluarga_di_jepang
                      : "なし"}
                  </td>
                  <td
                    className="value-text"
