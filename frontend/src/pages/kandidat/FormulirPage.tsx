...
export default function FormulirPage() {
  ...
  const validateStep = (stepNum: number): boolean => {
    ...
    if (stepNum === 1) {
      if (isEmpty(form.nama_katakana))
        newErrors.nama_katakana = "Nama Katakana wajib diisi";
      if (isEmpty(form.nama_romaji))
        newErrors.nama_romaji = "Nama Romaji wajib diisi";
      if (isEmpty(form.tempat_lahir))
        newErrors.tempat_lahir = "Tempat lahir wajib diisi";
      if (isEmpty(form.tanggal_lahir))
        newErrors.tanggal_lahir = "Tanggal lahir wajib diisi";
      if (isEmpty(form.umur)) newErrors.umur = "Umur wajib diisi";
      if (isEmpty(form.jenis_kelamin))
        newErrors.jenis_kelamin = "Jenis kelamin wajib dipilih";
      if (isEmpty(form.status_pernikahan))
        newErrors.status_pernikahan = "Status pernikahan wajib dipilih";
      if (isEmpty(form.agama)) newErrors.agama = "Agama wajib dipilih";
      if (isEmpty(form.tinggi_badan))
        newErrors.tinggi_badan = "Tinggi badan wajib diisi";
      if (isEmpty(form.berat_badan))
        newErrors.berat_badan = "Berat badan wajib diisi";
      if (isEmpty(form.golongan_darah))
        newErrors.golongan_darah = "Golongan darah wajib dipilih";
      if (isEmpty(form.tangan_dominan))
        newErrors.tangan_dominan = "Tangan dominan wajib dipilih";
      if (isEmpty(form.ukuran_baju))
        newErrors.ukuran_baju = "Ukuran baju wajib dipilih";
      if (isEmpty(form.nomor_hp)) newErrors.nomor_hp = "Nomor HP wajib diisi";
      if (isEmpty(form.email_kontak))
        newErrors.email_kontak = "Email wajib diisi";
      if (isEmpty(form.alamat_lengkap))
        newErrors.alamat_lengkap = "Alamat lengkap wajib diisi";
      if (isEmpty(form.kontak_ortu_nama))
        newErrors.kontak_ortu_nama = "Nama orang tua/wali wajib diisi";
      if (isEmpty(form.kontak_ortu_hp))
        newErrors.kontak_ortu_hp = "No. HP orang tua wajib diisi";
    }

    if (stepNum === 2) {
      if (
        form.sudah_vaksin === undefined ||
        form.sudah_vaksin === null ||
        form.sudah_vaksin === ""
      )
        newErrors.sudah_vaksin = "Pilih sudah/tidak vaksin";
      if (isEmpty(form.kondisi_kesehatan))
        newErrors.kondisi_kesehatan = "Kondisi kesehatan wajib dipilih";
      if (
        form.berkacamata === undefined ||
        form.berkacamata === null ||
        form.berkacamata === "" ||
        form.berkacamata === 0
      )
        newErrors.berkacamata = "Pilih ya/tidak";
      if (
        form.lensa_kontak === undefined ||
        form.lensa_kontak === null ||
        form.lensa_kontak === "" ||
        form.lensa_kontak === 0
      )
        newErrors.lensa_kontak = "Pilih ya/tidak";
      if (
        form.buta_warna === undefined ||
        form.buta_warna === null ||
        form.buta_warna === "" ||
        form.buta_warna === 0
      )
        newErrors.buta_warna = "Pilih ya/tidak";
      if (
        form.bertato === undefined ||
        form.bertato === null ||
        form.bertato === "" ||
        form.bertato === 0
      )
      ...
      if (
        form.minum_alkohol === undefined ||
        form.minum_alkohol === null ||
        form.minum_alkohol === "" ||
        form.minum_alkohol === 0
      )
        newErrors.minum_alkohol = "Pilih ya/tidak";
      if (isEmpty(form.riwayat_penyakit))
        newErrors.riwayat_penyakit =
          'Riwayat penyakit wajib diisi (isi "Tidak ada" jika tidak ada)';
    }
    ...
    if (stepNum === 3) {
      ...
      form.pendidikan.forEach((p: any, i: number) => {
        if (jenjangWajib.includes(p.jenjang)) {
          if (isEmpty(p.nama_sekolah))
            newErrors[`pendidikan_${i}_nama_sekolah`] =
              `Nama ${p.jenjang} wajib diisi`;
          if (isEmpty(p.bulan_masuk))
            newErrors[`pendidikan_${i}_bulan_masuk`] =
              "Bulan masuk wajib dipilih";
          if (isEmpty(p.tahun_masuk))
            newErrors[`pendidikan_${i}_tahun_masuk`] =
              "Tahun masuk wajib dipilih";
          if (isEmpty(p.bulan_lulus))
            newErrors[`pendidikan_${i}_bulan_lulus`] =
              "Bulan lulus wajib dipilih";
          if (isEmpty(p.tahun_lulus))
            newErrors[`pendidikan_${i}_tahun_lulus`] =
    ...
    if (stepNum === 5) {
      if (isEmpty(form.level_jlpt))
        newErrors.level_jlpt = "Level JLPT wajib dipilih";
      if (isEmpty(form.lama_belajar_jepang))
        newErrors.lama_belajar_jepang = "Lama belajar Jepang wajib diisi";
      if (isEmpty(form.level_bahasa_jepang))
        newErrors.level_bahasa_jepang = "Level bahasa Jepang wajib dipilih";
    }

    if (stepNum === 6) {
      if (isEmpty(form.penghasilan_keluarga))
        newErrors.penghasilan_keluarga = "Penghasilan keluarga wajib diisi";
      const ayah = form.keluarga.find((k: any) => k.hubungan === "Ayah");
      const ibu = form.keluarga.find((k: any) => k.hubungan === "Ibu");
      if (!ayah || isEmpty(ayah.nama))
        newErrors.keluarga_ayah_nama = "Nama Ayah wajib diisi";
      if (ayah && isEmpty(ayah.usia))
        newErrors.keluarga_ayah_usia = "Usia Ayah wajib diisi";
      if (ayah && isEmpty(ayah.pekerjaan))
        newErrors.keluarga_ayah_pekerjaan = "Pekerjaan Ayah wajib diisi";
      if (!ibu || isEmpty(ibu.nama))
        newErrors.keluarga_ibu_nama = "Nama Ibu wajib diisi";
      if (ibu && isEmpty(ibu.usia))
        newErrors.keluarga_ibu_usia = "Usia Ibu wajib diisi";
      if (ibu && isEmpty(ibu.pekerjaan))
        newErrors.keluarga_ibu_pekerjaan = "Pekerjaan Ibu wajib diisi";
    }
    ...
    if (stepNum === 8) {
      if (isEmpty(form.tujuan_ke_jepang))
        newErrors.tujuan_ke_jepang = "Tujuan ke Jepang wajib diisi";
      if (isEmpty(form.alasan_ke_jepang))
        newErrors.alasan_ke_jepang = "Alasan ingin ke Jepang wajib diisi";
      if (isEmpty(form.cita_cita_setelah_jepang))
        newErrors.cita_cita_setelah_jepang =
          "Cita-cita setelah pulang wajib diisi";
      if (isEmpty(form.rencana_pengiriman_uang))
        newErrors.rencana_pengiriman_uang =
          "Rencana pengiriman uang wajib diisi";
      if (isEmpty(form.kelebihan_diri))
        newErrors.kelebihan_diri = "Kelebihan diri wajib diisi";
      if (isEmpty(form.kekurangan_diri))
        newErrors.kekurangan_diri = "Kekurangan diri wajib diisi";
    ...
    if (stepNum === 9) {
      ...
      if (missing.length > 0)
        newErrors.dokumen = `${missing.length} dokumen belum diupload`;
    }
  ...
  const addKeluarga = (hubungan: string) => {
    const existing = form.keluarga.filter(
  ...
  const addSertifikatSsw = () =>
    setSertifikatSsw((p) => [...p, { id: null, nama_file: "", file: null }]);
      ...
      if (sswIndex !== undefined) {
        ...
        setForm((p: any) => {
          const docs = p.dokumen
            ? p.dokumen.filter((d: any) => d.jenis_dokumen !== jenis)
            : [];
          return {
            ...p,
            dokumen: [...docs, { jenis_dokumen: jenis, nama_file: file.name }],
          };
        });
      }
    } catch (err: any) {
    ...
    <div className="page-container max-w-4xl">
      ...
      <div className="mb-6">
        <div className="flex items-start justify-between flex-wrap gap-4">
          ...
          <Badge
            variant={curStatus.variant as any}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  />
                  {errors.umur && (
                    <p className="text-xs text-red-500">{errors.umur}</p>
                  )}
                </div>
                <div className="space-y-1.5">
                  ...
                  <Select
                    ...
                    onValueChange={setSel("jenis_kelamin")}
                  >
                ...
                <div className="space-y-1.5">
                  ...
                  {errors.agama && (
                    <p className="text-xs text-red-500">{errors.agama}</p>
                  )}
                </div>
                <div className="space-y-1.5">
                ...
                <div className="space-y-1.5">
                  ...
                  <Select
                    ...
                    onValueChange={setSel("ukuran_baju")}
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="col-span-2 space-y-1.5">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setPendidikan(i, "nama_sekolah", e.target.value)
                          }
                      ...
                      {(p.jenjang === "SMA/SMK" ||
                        p.jenjang === "Perguruan Tinggi") && (
                        <div className="col-span-2 space-y-1.5">
                          <Label>Jurusan</Label>
                          <Input
                            value={p.jurusan || ""}
                            onChange={(e) =>
                              setPendidikan(i, "jurusan", e.target.value)
                            }
                      ...
                      <div className="space-y-1.5">
                        ...
                        <YearMonthPicker
                          ...
                          onMonthChange={(v: string) =>
                            setPendidikan(i, "bulan_masuk", v)
                          }
                          onYearChange={(v: string) =>
                            setPendidikan(i, "tahun_masuk", v)
                          }
                        />
                      ...
                      <div className="space-y-1.5">
                        ...
                        <YearMonthPicker
                          ...
                          onMonthChange={(v: string) =>
                            setPendidikan(i, "bulan_lulus", v)
                          }
                          onYearChange={(v: string) =>
                            setPendidikan(i, "tahun_lulus", v)
                          }
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <Select
                    value={form.level_jlpt || ""}
                    onValueChange={setSel("level_jlpt")}
                  >
                ...
                <div className="space-y-1.5">
                  ...
                  <Select
                    value={form.level_jft || ""}
                    onValueChange={setSel("level_jft")}
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Pilih level..." />
                    </SelectTrigger>
          ...
          {step === 6 && (
            <div className="space-y-4">
              ...
              {["Ayah", "Ibu", "Suami", "Istri", "Kakak", "Adik"].map((hubungan) => {
                ...
                const canAdd = hubungan === "Kakak" || hubungan === "Adik" || hubungan === "Suami" || hubungan === "Istri";
                            ...
                            <div className="col-span-2 sm:col-span-1 space-y-1.5">
                              ...
                              <Input
                                ...
                                error={
                                  isRequired &&
                                  !!errors[
                                    `keluarga_${hubungan.toLowerCase()}_nama`
                                  ]
                                }
                              />
                              {isRequired &&
                            ...
                            <div className="space-y-1.5">
                              ...
                              <Input
                                ...
                                error={
                                  isRequired &&
                                  !!errors[
                                    `keluarga_${hubungan.toLowerCase()}_usia`
                                  ]
                                }
                              />
                              {isRequired &&
                            ...
                            <div className="space-y-1.5">
                              ...
                              <Input
                                ...
                                error={
                                  isRequired &&
                                  !!errors[
                                    `keluarga_${hubungan.toLowerCase()}_pekerjaan`
                                  ]
                                }
                              />
                              {isRequired &&
          ...
          {step === 8 && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="space-y-1.5">
                  <Label className="required">
                    Cita-cita Setelah Pulang dari Jepang *
                  </Label>
                  <Textarea
                    ...
                    rows={3}
                    className={
                      errors.cita_cita_setelah_jepang ? "border-red-500" : ""
                    }
                  />
                ...
                <div className="space-y-1.5">
                  <Label className="required">
                    Rencana Pengiriman Uang/Bulan ke Indonesia (Rp) *
                  </Label>
                  <Input
                    type="number"
                ...
                <div className="space-y-1.5">
                  ...
                  />
                  {errors.hobi && (
                    <p className="text-xs text-red-500">{errors.hobi}</p>
                  )}
                </div>
                <div className="space-y-1.5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                ...
                <div className="space-y-1.5">
                  <Label className="required">
                    Lama Ingin Bekerja di Perusahaan *
                  </Label>
                  <Select
                ...
                <div className="space-y-1.5">
                  <Label className="required">
                    Rencana Pulang ke Indonesia (5 tahun) *
                  </Label>
                  <Select
                ...
                <div className="space-y-1.5">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Dana Talang LPK">
                        Dana Talang LPK
                      </SelectItem>
                    </SelectContent>
                  </Select>
                  ...
                  return (
                    ...
                    >
                      ...
                      <label className="cursor-pointer">
                          ...
                          onChange={(e) => {
                            ...
                            if (file.size > MAX_SIZE) {
                              toast({
                                ...
                                description: "Maksimal ukuran file adalah 500KB",
                                variant: "destructive",
                              });
                              return;
                            }
                        ...
                        <div
                          className={`flex items-center gap-2 text-xs px-3 py-1.5 border rounded-md w-fit transition-colors ${
                            isSubmitted
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <label className="cursor-pointer mt-2 inline-block">
                            ...
                            <div
                              className={`flex items-center gap-2 text-xs px-3 py-1.5 border rounded-md transition-colors ${
                                isSubmitted
                                  ? "opacity-50 cursor-not-allowed"
                                  : "hover:bg-muted cursor-pointer"
                              } ${
      ...
      <div className="flex items-center justify-between mt-6">
        ...
        <div className="flex items-center gap-3">
          ...
          {step < STEPS.length ? (
            ...
            <Button
              onClick={async () => {
                const allStepsValid = [1, 2, 3, 5, 6, 7, 8, 9].every((s) =>
                  validateStep(s),
                );
                if (!allStepsValid) {
                  toast({
